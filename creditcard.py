...
if __name__ == '__main__':
    wallet = []
    wallet.append(CreditCard('AKHIL','SBI Bank','1245 7896 8574 3214',55000))
    wallet.append(CreditCard( 'RAMANA' , 'ANDHRA Bank' ,'3656 5487 9685 4512' , 40000))
    wallet.append(CreditCard( 'VISWAK SEN' , 'ICICI Bank' , '4565 8597 6985 3256' , 50000))
    for c in range(3):
